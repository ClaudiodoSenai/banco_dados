...
-- selecionar todas as pizzas que não tem valor cadastrado
select * from pizza where valor <=> null;
select * from pizza where valor is null;
select * from pizza where isnull(valor);

-- selecionar toodas as pizzas com valores entre R$ 15 e R$ 20
select * from pizza where valor > 15 and valor < 20;

-- selecionar toodas as pizzas com valores menores ou maiores que R$ 17,00
...
-- selecionar todas as pizzas com valores na faixa R$ 17,00 e R$20,00
select * from pizza where valor >= 17 and valor <= 20;
select * from pizza where valor between 17 and 20;

-- selecionar todas as pizzas com valores fora da faixa de R$ 17 a R$ 20,00
