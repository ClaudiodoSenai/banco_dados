...
begin
	...
	while i <= 1000000 do set estado_aleatorio = floor(rand() *27) +1;
	insert into exemplo (nome,estado) values(concat('Nome', i),(select nome from estados_brasil where id = estado_aleatorio));
	set i = i + 1;
end while ;
end//
delimiter ;
